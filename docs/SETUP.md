# Meeting AI Assistant — Hướng dẫn Cài đặt & Vận hành
...
```bash
git clone <repo-url> real-time-meeting-ai
cd real-time-meeting-ai
...
### Bước 4: Khởi động Server Stack
```bash
make all   # = env + build + up
```
...
$env:SERVER_WS            = "ws://192.168.1.100:8765"
$env:SERVER_REST          = "http://192.168.1.100:8056"
...
4. Trỏ đến thư mục: `chrome_extension/`

### Bước 2: Kiểm tra kết nối Bridge
1. Chạy `python -m client.ui.main_app`
2. Click icon extension **Meeting AI Bridge**
...
### Google Meet (Chrome)
- Mở Google Meet trên Chrome và đảm bảo extension **Meeting AI Bridge** đang bật
...
2. **Ctrl+V** vào Meeting AI side-panel
...
Meeting AI Assistant giữ nguyên pattern này và thêm:
