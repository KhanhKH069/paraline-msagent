...
logger = logging.getLogger("meeting_ai.teams")
...
class TeamsClient:
    ...
    def send_welcome(self) -> bool:
        msg = (
            "🟠 **Meeting AI Assistant** đã kết nối!\n"
    ...
    def _webhook_send(self, text: str) -> bool:
        payload = {
            ...
            "summary": "Meeting AI Translation",
            "sections": [{"activityTitle": "🟠 Meeting AI Assistant", "activityText": text}],
        }
