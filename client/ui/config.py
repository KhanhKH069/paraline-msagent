...
SERVER_WS   = os.getenv("SERVER_WS",   "ws://127.0.0.1:8056")
SERVER_REST = os.getenv("SERVER_REST", "http://127.0.0.1:8056")
API_KEY     = os.getenv("CLIENT_API_KEY", "meeting_client_secret_key_local")
