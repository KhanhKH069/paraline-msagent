...
QLabel#pri_low {
    background: #f0f7ff; color: #0284c7;
    font-size: 9px; font-weight: 800; border-radius: 4px; padding: 2px 5px;
}
...
QPushButton#btn_home {
    ...
    color: rgba(255,255,255,0.6); font-size: 16px; font-weight: bold; padding: 0;
}
QPushButton#btn_home:hover { color: #00e5a0; }
