...
Meeting AI Assistant được xây dựng dựa trên **core pattern của Vexa AI** (api-gateway → WhisperLive → transcription-collector), mở rộng thêm các layer dịch thuật, TTS, Vision và AI Agent.
...
```bash
# 1. Clone & cấu hình
git clone <repo> && cd real-time-meeting-ai
cp .env.example .env
...
$env:SERVER_WS            = "ws://<IP_SERVER>:8765"
$env:SERVER_REST          = "http://<IP_SERVER>:8056"
