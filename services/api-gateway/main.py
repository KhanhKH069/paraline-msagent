...
Meeting AI Assistant — API Gateway
...
logger = logging.getLogger("meeting_ai.gateway")


@asynccontextmanager
async def lifespan(app: FastAPI):
    logger.info("🟠 Meeting AI Assistant API Gateway starting...")
    ...
    yield
    logger.info("Meeting AI Assistant shutting down.")
