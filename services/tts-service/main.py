...
logger = logging.getLogger("meeting_ai.tts")

VOICE     = os.getenv("PIPER_VOICE", "vi_VN-vais1000-medium")
MODEL_DIR = os.getenv("MODEL_CACHE_DIR", "/models/piper")
SR        = int(os.getenv("SAMPLE_RATE", "22050"))

app = FastAPI(title="Meeting AI TTS Service")
...
async def synthesize(req: SynthReq):
    ...
    try:
        ...
        config_path = f"{MODEL_DIR}/{VOICE}.onnx.json"
